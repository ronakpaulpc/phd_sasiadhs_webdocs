...
```{r}
#| label: set-default-filepath
#| echo: false
#| output: false
#| cache: false

# Setting correct relative file path for markdown doc
here::i_am("sasiadhs_qdocs_ind-reports/dapool_prechk-v01_mvdhs.qmd") 
...
mvbr1_tmp_intro <- read_rds(
  file = here("sasiadhs_data_prep", "mvbr1_nest0.rds")
)
# Importing the mvir nested tibble
mvir1_tmp_intro <- read_rds(
  file = here("sasiadhs_data_prep", "mvir1_nest0.rds")
)
# Importing the mvhr nested tibble
mvhr1_tmp_intro <- read_rds(
  file = here("sasiadhs_data_prep", "mvhr1_nest0.rds")
)
# Importing the mvpr nested tibble
mvpr1_tmp_intro <- read_rds(
  file = here("sasiadhs_data_prep", "mvpr1_nest0.rds")
)
...
mvbr1_pre_tmp0 <- read_rds(file = here("sasiadhs_data_prep", "mvbr1_nest0.rds"))
# Import the mvhr nested tibble
mvhr1_pre_tmp0 <- read_rds(file = here("sasiadhs_data_prep", "mvhr1_nest0.rds"))
# Import the mvpr nested tibble
mvpr1_pre_tmp0 <- read_rds(file = here("sasiadhs_data_prep", "mvpr1_nest0.rds"))
