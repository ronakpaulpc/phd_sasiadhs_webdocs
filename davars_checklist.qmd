...
bddhs <- tribble(
    ...
    "Wealth index quintile (BR)",       NA, NA, NA, "v190", "v190", "v190", "v190", "v190", "v190", 
...
-   In Bangladesh DHS 1993, 1996 and 1996 the wealth index variables are available in the HR files.
...
iadhs <- tribble(
    ...
    "Wealth index quintile (BR)",       NA, NA, "v190", "v190", "v190", 
...
-   In India DHS 1992 and 1998 the wealth index variables are available in the HR files.
...
mvdhs <- tribble(
    ...
    "Wealth index quintile (BR)",       "v190", "v190", 
...
-   There are no common social group variables across all the Maldives DHS rounds.
...
npdhs <- tribble(
    ...
    "Wealth index quintile (BR)",       NA, NA, "v190", "v190", "v190", "v190",
...
-   The language-related variables are in the IR and BR files.
-   In Nepal DHS 1996 and 2001 the wealth index variables are available in a separate file.
...
pkdhs <- tribble(
    ...
    "Wealth index quintile (BR)",       NA, "v190", "v190", "v190",
...
-   The language-related variables are in the IR and BR files.
-   In Pakistan DHS 1990 the wealth index variables are available in a separate file.
